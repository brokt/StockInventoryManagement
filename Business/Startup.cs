...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(BusinessStartup).GetTypeInfo().Assembly));
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ProjectDbContext, DArchInMemory>(ServiceLifetime.Scoped);
        ...
        public void ConfigureStagingServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGroupClaimRepository, GroupClaimRepository>();
            services.AddTransient<IUserGroupRepository, UserGroupRepository>();
            services.AddDbContext<ProjectDbContext,MySqlDbContext>(ServiceLifetime.Scoped);
