...
namespace WebAPI.Controllers
{
    ...
    public class TranslatesController : BaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet]
        public async Task<IActionResult> GetTranslatesList()
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPost]
        public async Task<IActionResult> AddTranslate([FromBody] CreateTranslateCommand createTranslate)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPut]
        public async Task<IActionResult> UpdateTranslate([FromBody] UpdateTranslateDto updateTranslateDto)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(string))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpDelete("deleteTranslate/{id}")]
        public async Task<IActionResult> DeleteTranslate([FromRoute] int id)
        {
