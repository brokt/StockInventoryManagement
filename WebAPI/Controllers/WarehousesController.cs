...
namespace WebAPI.Controllers
{
    ...
    public class WarehousesController : BaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPost]
        public async Task<IActionResult> AddWarehouse([FromBody] CreateWarehouseCommand createWarehouse)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPut]
        public async Task<IActionResult> UpdateWarehouse([FromBody] UpdateWarehouseCommand updateWarehouse)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpDelete]
        public async Task<IActionResult> DeleteWarehouse([FromBody] DeleteWarehouseCommand deleteWarehouse)
        {
