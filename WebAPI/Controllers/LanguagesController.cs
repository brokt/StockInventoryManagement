...
namespace WebAPI.Controllers
{
    ...
    public class LanguagesController : BaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPost]
        public async Task<IActionResult> AddLanguage([FromBody] CreateLanguageCommand createLanguage)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPut]
        public async Task<IActionResult> UpdateLanguage([FromBody] UpdateLanguageDto updateLanguageDto)
        {
