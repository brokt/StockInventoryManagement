...
namespace WebAPI.Controllers
{
    ...
    public class OperationClaimsController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetOperationClaimsList()
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getOperationClaim/{id}")]
        public async Task<IActionResult> GetOperationClaimByid([FromRoute] int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getOperationClaimLookups")]
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpPut]
        public async Task<IActionResult> UpdateOperationClaim([FromBody] UpdateOperationClaimDto updateOperationClaimDto)
        {
